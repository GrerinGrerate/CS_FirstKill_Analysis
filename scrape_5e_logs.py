...
def get_round_tabs(driver):
    WebDriverWait(driver, 15).until(EC.presence_of_element_located((By.CSS_SELECTOR, "ul.bout-list-box")))
...
def open_log_modal(driver):
    btn = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.CSS_SELECTOR, "div.game-logs-show")))
...
def read_modal_logs(driver):
    WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.CSS_SELECTOR, "div.live-log-item")))
    soup  = BeautifulSoup(driver.page_source, "html.parser")
